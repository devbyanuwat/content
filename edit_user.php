...
<body>
    ...
    <div class=" container">
        <div style="background-color: #0A1334;">
            ...
            <div class="row">
                <form method="post" style="background-color: #0A1334;" action="backend/user/edit.php?user_id=<?php echo $user_id; ?>" class="d-md-flex justify-content-md-center">
                    <div class="text-white" style="background-color: #12234E;width: 75%;padding: 15px;  border-radius: 10px;">
                        ...
                        <div class="col" style="background-color: #12234E;">
                            Tel.
                            <input type="text" class="form-control" name="user_tel" value="<?php echo $user_tel; ?>" required>
                        </div>
                        <div class="col" style="background-color: #12234E;">
                            Username
                            <input type="text" class="form-control" name="user_username" value="<?php echo $user_username; ?>" required>
                        </div>
                        <div class="col" style="background-color: #12234E;">
                            Password
                        ...
                        <div class="row mt-3">
                            <div class="col-6 mx-auto" style="background-color: #12234E;">
                                <button type="submit" class="btn-warning text-white" style="width: 100%;">Save</button>
